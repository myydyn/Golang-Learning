import { CategoryCondiDTO, CategoryCreateDTO, CategoryUpdateDTO } from "../model/dto";
...
export class CategoryUseCase implements ICategoryUseCase {
    ...
    async listCategories(cond: CategoryCondiDTO, paging: PagingDTO): Promise<Category[] | null> {
